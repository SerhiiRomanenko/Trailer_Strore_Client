...
const ContactsPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (descTag) {
      descTag.setAttribute('content', "Зв'яжіться з нами для консультації та замовлення причепів. Адреса, телефон та email магазину Trailers.");
    }
  }, []);
  ...
  const inputClasses = "w-full px-4 py-2.5 bg-white border border-slate-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-colors";

  return (
    <div className="bg-white p-6 sm:p-8 rounded-xl shadow-lg border border-slate-200">
      <h1 className="text-4xl font-black text-slate-900 mb-8 text-center">Контакти</h1>
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        {/* Left Column: Info & Map */}
        <div className="space-y-8">
          <div>
            <h2 className="text-2xl font-bold text-slate-800 mb-4">Зв'яжіться з нами</h2>
            <div className="space-y-4 text-slate-600">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a className="text-orange-600 hover:text-orange-700 hover:underline" href="tel:380679372731">
                    +38 (067) 937-27-31
                  </a>
                </div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a className="text-orange-600 hover:text-orange-700 hover:underline" href="mailto:serhiiromanenko13@gmail.com">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-slate-800">Години роботи</h3>
          ...
          <div>
            <h2 className="text-2xl font-bold text-slate-800 mb-4">Наше розташування</h2>
        ...
        <div>
          <div className="bg-slate-50 p-8 rounded-lg border border-slate-200 h-full">
            <h2 className="text-2xl font-bold text-slate-800 mb-6">Напишіть нам</h2>
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                <label htmlFor="name" className="block text-sm font-medium text-slate-700 mb-1">Ваше ім'я</label>
                <input
                  type="text"
                  name="name"
                  id="name"
              ...
              <div>
                <label htmlFor="email" className="block text-sm font-medium text-slate-700 mb-1">Ваш Email</label>
                <input
                  type="email"
                  name="email"
                  id="email"
              ...
              <div>
                <label htmlFor="message" className="block text-sm font-medium text-slate-700 mb-1">Повідомлення</label>
                <textarea
                  name="message"
                  id="message"
                  required
